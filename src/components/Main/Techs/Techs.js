            ...
            <div className="techs__page">
                ...
                <div className="techs__container">
                    ...
                    <ul className="techs__links">
                        ...
                        <li className="techs__item">
                            <a className="techs__link" href="https://developer.mozilla.org/ru/docs/Web/CSS"
                               target="_blank" rel="noreferrer">
                                CSS
                            </a>
                        </li>
                        <li className="techs__item">
                            <a className="techs__link" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript"
                               target="_blank" rel="noreferrer">
                                JS
                            </a>
                        </li>
                        ...
                        <li className="techs__item">
                            <a className="techs__link" href="https://expressjs.com/ru/" target="_blank"
                               rel="noreferrer">
                                Express.js
                            </a>
                        </li>
